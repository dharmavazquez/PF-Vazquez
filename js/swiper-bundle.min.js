...
!function(e, t) {
        ...
        updateSlides: function() {
            ...
            for (let i = 0; i < m; i += 1) {
                ...
                !p[i] || "none" !== w(r, "display")) {
                    ...
                    v.push(A),
                    a.centeredSlides ? (M = M + A / 2 + C / 2 + T,
                    0 === C && 0 !== i && (M = M - n / 2 - T),
                    0 === i && (M = M - n / 2 - T),
                    Math.abs(M) < .001 && (M = 0),
    ...
    function X() {
        ...
        e.autoplay && e.autoplay.running && e.autoplay.paused && (clearTimeout(H),
        H = setTimeout((()=>{
    ...
    const K = {
        ...
        events: {
            attachEvents: function() {
                ...
                e.onClick = Y.bind(e),
                e.onLoad = R.bind(e),
                _ || (t.addEventListener("touchstart", F),
                _ = !0),
                V(e, "on")
            },
    ...
    , function(e) {
        ...
        function C() {
            const e = t.zoom;
            m.slideEl && t.previousIndex !== t.activeIndex && (m.imageEl && (m.imageEl.style.transform = "translate3d(0,0,0) scale(1)"),
        ...
        a("touchStart", ((e,s)=>{
            t.zoom.enabled && function(e) {
                const s = t.device;
                m.imageEl && (h.isTouched || (s.android && e.cancelable && e.preventDefault(),
                h.isTouched = !0,
